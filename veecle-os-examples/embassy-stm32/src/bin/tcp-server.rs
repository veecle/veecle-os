...
async fn main(spawner: Spawner) -> ! {
    let peripherals = veecle_os_examples_embassy_stm32::initialize_board();
    ...
    let net_stack = veecle_os_examples_embassy_stm32::initialize_networking(
        spawner,
        peripherals,
        net_config,
    ...
    veecle_os::runtime::execute! {
        store: [],
        actors: [
            TcpServerActor<_, veecle_os::osal::embassy::log::Log>: (socket, SERVER_ADDRESS),
        ],
    }
    .await
}
