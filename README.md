...
rand = "0.9.2"
tokio = "1.48.0"
# Uses a git dependency until the `ConsolePrettyExporter` is released.
veecle-os = { git = "https://github.com/veecle/veecle-os", branch = "main", features = ["telemetry-enable", "osal-std"] }
```

Add the following code to you `main.rs` file.
...
use veecle_os::telemetry::collector::{ConsolePrettyExporter, set_exporter};
use veecle_os::telemetry::protocol::ExecutionId;
